...
#
# Current setting: DISABLED (torch.compile has dynamic shape issues with DuQuant)
...
# DuQuant dynamically initializes activation scales, which conflicts with CUDA Graphs
